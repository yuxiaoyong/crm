...
public final class EncodingUtils {
	...
	public static String getFileEncoding(String filePath){
		...
		String encoding = BytesEncodingDetect.javaname[detect.detectEncoding(new File(filePath))];
		return encoding;
	}
	 ...
	 * 获取文件的编码类型
	 * 
	 * @version 1.0.0, 2017年6月13日-下午1:28:19
	 * @param data
	 * @return String
	 */
	public static String getFileEncoding(byte[] data){
		BytesEncodingDetect detect = new BytesEncodingDetect();
		String encoding = BytesEncodingDetect.javaname[detect.detectEncoding(data)];
		return encoding;
	}
}
